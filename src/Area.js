  ...
  render() {
    if (!this.props.area.discovered) {
      ...
      if (this.props.position) {
        ...
        return <button className="Area-Btn-StartEnd" onClick={async () => await this.props.move()}>
        ...
        return <button className="Area-Btn-Pokemon" onClick={async () => await this.props.move()}>
          <img alt="" src='https://art.pixilart.com/e31381479f0aa74.png' />
        </button>
      } else if (this.props.area.attribute.name === 'merchant') {
        return <button className="Area-Btn-Merchant" onClick={async () => await this.props.move()}>
        ...
        return <button className='Area-Btn-Random' onClick={async () => await this.props.move()}>
          <img alt="" src='https://cdn.dribbble.com/users/1037956/screenshots/4456763/800x600_1x.png'/>
        </button>
      } else {
        return <button className="Area-Btn" onClick={async() => await this.props.move()}></button>
      }
    }
  }
}
