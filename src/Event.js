...
class Event extends Component {
  ...
  choice1C() {
    let arr1 = this.state.cards;
    let arr2 = this.state.cardsCanBeUsed;
  ...
  render() {
    ...
    return <div>{ index === 0 ?
      <ReactModal
        ...
        <div className='align'>
          <img alt="" className='image' height='175px' width='250px' src='https://vignette.wikia.nocookie.net/slay-the-spire/images/e/ea/Event_-_Big_Fish.jpg/revision/latest/scale-to-width-down/220?cb=20171204232609' />
          ...
          <button className='choiceC' onClick={() => this.choice1C()}>Box</button>
        </div>
      </ReactModal> : index === 1 ?
      <ReactModal
        className='event'
        ...
        <div className='align'>
          <img alt="" className='image' height='175px' width='250px' src='https://vignette.wikia.nocookie.net/slay-the-spire/images/1/1c/Event_-_The_Cleric.jpg/revision/latest/scale-to-width-down/220?cb=20171204230636' />
          ...
          <button className='choiceC' onClick={() => this.choice2C()}>Refuse his blessings</button>
        </div>
      </ReactModal>
      : index === 2 ?
      <ReactModal
        ...
        contentLabel="Event B">
        <div className='align'>
          <img alt="" className='image' height='175px' width='250px' src='https://vignette.wikia.nocookie.net/slay-the-spire/images/5/5a/Event_-_Golden_Idol.jpg/revision/latest/scale-to-width-down/220?cb=20171204235226' />
          ...
          <button className='choiceC' onClick={() => this.choice3C()}>Pretend nothing happens</button>
        </div>
      </ReactModal>
      : index === 3 ?
      <ReactModal
        ...
        contentLabel="Event B">
        <div className='align'>
          <img alt="" className='image' height='175px' width='250px' src='https://vignette.wikia.nocookie.net/slay-the-spire/images/8/83/Event_-_Drug_Dealer.jpg/revision/latest/scale-to-width-down/220?cb=20171205001026' />
          ...
          <button className='choiceC' onClick={() => this.choice4C()}>Leave</button>
        </div>
      </ReactModal>
      : index === 4 ?
      <ReactModal
        ...
        contentLabel="Event B">
        <div className='align'>
          <img alt="" className='image' height='175px' width='250px' src='https://www.blogcdn.com/www.joystiq.com/media/2011/03/portals.031411-530px.jpg' />
      ...
      <ReactModal
        ...
        contentLabel="Event B">
        <div className='align'>
          <img alt="" className='image' height='175px' width='250px' src='https://vignette.wikia.nocookie.net/slay-the-spire/images/4/4c/Event_-_World_of_Goop.jpg/revision/latest/scale-to-width-down/220?cb=20171207165301' />
          ...
          <button className='choiceC' onClick={() => this.choice6C()}>Give up</button>
        </div>
      </ReactModal>
      : ''
    }</div>
